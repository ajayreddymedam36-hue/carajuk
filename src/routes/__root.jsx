  ...
  head: () => ({
    meta: [
      ...
      { title: "CA Raju Koyyala & Associates — Chartered Accountants, Hanamkonda" },
      {
        name: "description",
        content:
          "Trusted CA firm in Hanamkonda offering GST, ITR, audit, company registration, tax planning & bookkeeping. 500+ clients served.",
      },
      { name: "author", content: "CA Raju Koyyala & Associates" },
